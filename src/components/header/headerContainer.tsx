...
export default function HeaderContainer() {
    ...
    const menuItemsHamburguer = [
        "Breaking News", "Hi News", "Programación", "Contenido HS", "Podcast", "Próximos eventos", "Hi Punch",
        "Pepsi Center", "Copa Francia", "Talento"
    ...
    return (
        <>
            ...
            <div className='md:flex hidden  justify-between'>
                ...
                } style={{ background: "linear-gradient(45deg, #014aad, #692495, #692495, #014aad)", width: "350px" }} placement="left" onClose={onClose} open={open}>
