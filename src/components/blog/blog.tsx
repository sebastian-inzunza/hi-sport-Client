    ...
    return (
        ...
        <>
            <Head>
                ...
                <meta property='og:image' content='https://www.record.com.mx/sites/default/files/styles/v2-crop768x433/public/articulos/2023/09/05/chinohuertatri2.jpg?itok=yGRMnuc0&changed=20230905210351' />

                <meta name='twitter:title' content='Hi! Sports' />
                <meta name='twitter:description' content={'Hi Sports. id=' + id} />
                <meta name='twitter:image' content='https://www.record.com.mx/sites/default/files/styles/v2-crop768x433/public/articulos/2023/09/05/chinohuertatri2.jpg?itok=yGRMnuc0&changed=20230905210351' />
                <meta name='twitter:card' content='https://www.record.com.mx/sites/default/files/styles/v2-crop768x433/public/articulos/2023/09/05/chinohuertatri2.jpg?itok=yGRMnuc0&changed=20230905210351' />
            </Head>
                ...
                <div className='relative bg-stone-600/80 px-8 redondo container mx-auto'>
                    ...
                    <div className='pb-8 rounded-b-lg'>
                        <div className='md:mx-24 pt-2 text-left'>
                            ...
                            <div className='gb-purple-500/40'>
